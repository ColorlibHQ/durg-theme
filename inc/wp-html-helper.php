...
// image default alt
if ( ! function_exists( 'durg_img_default_alt' ) ) {
	function durg_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'durg_img_tag' ) ) {
	function durg_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'durg_anchor_tag' ) ) {
	function durg_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'durg_heading_tag' ) ) {
	function durg_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'durg_paragraph_tag' ) ) {
	function durg_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'durg_other_tag' ) ) {
	function durg_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'durg_button_element ' ) ) {
	function durg_button_element( array $args ) {
