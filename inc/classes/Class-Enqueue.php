 ...
 */
	...
	class durg_Enqueue{
		...
		public function durg_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'durg_frontend_enqueue_scripts', ) );
		}

		public function durg_frontend_enqueue_scripts( ){
